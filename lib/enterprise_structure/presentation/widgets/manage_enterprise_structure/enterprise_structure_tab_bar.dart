...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/config/enterprise_structure_tab_labels.dart';
...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/config/enterprise_structure_tabs_config.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: tabs.asMap().entries.map((entry) {
            ...
            final label = EnterpriseStructureTabLabels.localized(tab.labelKey, localizations);
