...
class OrgUnitTreeNodeWidget extends StatelessWidget {
  ...
  String _getLevelCodeIcon(String levelCode) {
    switch (levelCode.toUpperCase()) {
      case 'COMPANY':
        return EnterpriseStructureAssets.icons.companyTreeIcon.path;
      case 'DIVISION':
        return EnterpriseStructureAssets.icons.divisionTreeIcon.path;
      case 'BUSINESS_UNIT':
        return EnterpriseStructureAssets.icons.businessUnitTreeIcon.path;
      case 'DEPARTMENT':
        return EnterpriseStructureAssets.icons.departmentTreeIcon.path;
      case 'SECTION':
        return EnterpriseStructureAssets.icons.sectionTreeIcon.path;
      default:
        return EnterpriseStructureAssets.icons.companyTreeIcon.path;
    }
  }
