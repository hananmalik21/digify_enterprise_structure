...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/structures_list_skeleton.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/structure_card_widget.dart';
...
class StructuresListWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final verticalGap = context.responsiveFine<double>(
      mobile: 16.h,
      tabletSmall: 16.h,
      tabletMedium: 16.h,
      tabletLarge: 18.h,
    ...
    final cardsSection = Column(
      ...
      children: [
        for (var i = 0; i < cards.length; i++)
          Padding(
            padding: EdgeInsetsDirectional.only(bottom: i < cards.length - 1 ? verticalGap : 0),
            child: cards[i],
          ),
      ],
    );
