  ...
  Widget _buildLayout(BuildContext context, {EnterpriseStats? stats, bool isSkeleton = false}) {
    ...
    final cards = [
      _EnterpriseStatCard(
        ...
        iconPath: EnterpriseStructureAssets.icons.totalStructuresIcon.path,
      ...
      _EnterpriseStatCard(
        ...
        iconPath: EnterpriseStructureAssets.icons.activeStructureIcon.path,
        isDark: widget.isDark,
        iconColor: StatsCardsWidget._iconColor,
        iconBgLight: StatsCardsWidget._iconBackgroundLight,
      ),
      _EnterpriseStatCard(
        ...
        iconPath: EnterpriseStructureAssets.icons.componentsIcon.path,
        isDark: widget.isDark,
        iconColor: StatsCardsWidget._iconColor,
        iconBgLight: StatsCardsWidget._iconBackgroundLight,
      ),
      _EnterpriseStatCard(
        ...
        iconPath: EnterpriseStructureAssets.icons.employeesAssignedIcon.path,
        isDark: widget.isDark,
        iconColor: StatsCardsWidget._iconColor,
        iconBgLight: StatsCardsWidget._iconBackgroundLight,
      ),
