...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/providers/save_enterprise_structure_provider.dart';
...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/dialogs/enterprise_structure_dialog.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/helpers/structure_activate_handler.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/helpers/structure_delete_handler.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/helpers/structure_level_helper.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/hierarchy_levels_widget.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/structure_metrics_widget.dart';
...
class StructureCardWidget extends StatelessWidget {
  ...
  final EnterpriseStructureLocalizations localizations;
  final bool isDark;
  final String title;
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            DigifyAsset(
              assetPath: EnterpriseStructureAssets.icons.infoIconGreen.path,
              width: 16.w,
              height: 16.h,
      ...
      children: [
        if (!isActive && canActivateStructure)
          AppButton(
            ...
            svgPath: EnterpriseStructureAssets.icons.checkIconGreen.path,
        ...
        if (canViewStructure)
          AppButton(
            ...
            svgPath: EnterpriseStructureAssets.icons.viewIconBlue.path,
        ...
        if (canUpdateStructure)
          AppButton(
            ...
            svgPath: EnterpriseStructureAssets.icons.editIconGreen.path,
            backgroundColor: AppColors.infoBg,
            foregroundColor: AppColors.primary,
        ...
        if (!isActive && canDeleteStructure)
          AppButton(
            ...
            svgPath: EnterpriseStructureAssets.icons.deleteIconRed.path,
