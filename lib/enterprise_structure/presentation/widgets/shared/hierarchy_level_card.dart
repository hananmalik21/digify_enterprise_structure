...
class _ArrowButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        DigifyAssetButton(
          assetPath: EnterpriseStructureAssets.icons.enterpriseStructure.upArrow.path,
        ...
        Gap(4.h),
        DigifyAssetButton(
          assetPath: EnterpriseStructureAssets.icons.enterpriseStructure.downArrow.path,
