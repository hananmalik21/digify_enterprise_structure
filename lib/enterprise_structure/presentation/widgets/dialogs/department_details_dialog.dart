...
import 'package:digify_enterprise_structure/enterprise_structure/domain/models/department.dart';
...
class DepartmentDetailsDialog extends StatelessWidget {
  ...
  Widget _buildHeader(BuildContext context, EnterpriseStructureLocalizations localizations) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(assetPath: EnterpriseStructureAssets.icons.departmentCardIcon.path, width: 20, height: 20, color: Colors.white),
              SizedBox(width: 8.w),
              Text(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.closeDialogIcon.path,
                width: 20,
                height: 20,
                color: Colors.white,
              ),
  ...
  Widget _buildTitleBlock(BuildContext context, EnterpriseStructureLocalizations localizations) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildBasicInformationSection(BuildContext context, EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader(context, localizations.basicInformation, EnterpriseStructureAssets.icons.companyStatIcon.path, isDark),
  ...
  Widget _buildLeadershipSection(BuildContext context, EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader(context, localizations.departmentLeadership, EnterpriseStructureAssets.icons.headIcon.path, isDark),
        SizedBox(height: 12.h),
        Container(
          width: double.infinity,
          padding: EdgeInsets.all(16.w),
          ...
          child: Column(
            ...
            children: [
              ...
              _buildContactRow(
                context,
                EnterpriseStructureAssets.icons.emailIcon.path,
              ...
              _buildContactRow(
                context,
                EnterpriseStructureAssets.icons.phoneIcon.path,
  ...
  Widget _buildMetricsSection(BuildContext context, EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader(
          ...
          EnterpriseStructureAssets.icons.departmentMetricIcon.path,
          isDark,
        ),
        SizedBox(height: 12.h),
        Row(
          children: [
            ...
            _buildMetricCard(
              ...
              EnterpriseStructureAssets.icons.departmentMetric2Icon.path,
              isDark,
            ),
            SizedBox(width: 12.w),
            _buildMetricCard(
              ...
              EnterpriseStructureAssets.icons.departmentMetric3Icon.path,
              isDark,
            ),
          ],
        ),
  ...
  Widget _buildDescription(BuildContext context, EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader(context, localizations.departmentDescription, EnterpriseStructureAssets.icons.departmentCardIcon.path, isDark),
        SizedBox(height: 12.h),
        Container(
          padding: EdgeInsets.all(16.w),
          decoration: BoxDecoration(
