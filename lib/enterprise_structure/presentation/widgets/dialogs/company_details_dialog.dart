...
class CompanyDetailsDialog extends StatelessWidget {
  ...
  Widget _buildHeader(EnterpriseStructureLocalizations localizations) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(assetPath: EnterpriseStructureAssets.icons.companyStatIcon.path, width: 20, height: 20, color: Colors.white),
              SizedBox(width: 8.w),
              Text(
  ...
  Widget _buildContactInformation(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildFinancialAndOperational(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
