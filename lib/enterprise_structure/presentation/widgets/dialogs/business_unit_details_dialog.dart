              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildSection(context, localizations.basicInformation, EnterpriseStructureAssets.icons.businessUnitBasicIcon.path, [
                      ...
                      _buildSection(context, localizations.leadership, EnterpriseStructureAssets.icons.leadershipIcon.path, [
                        ...
                        _buildIconRow(
                          ...
                          EnterpriseStructureAssets.icons.headEmailIcon.path,
                        ),
                        SizedBox(height: 8.h),
                        _buildIconRow(
                          context,
                          ...
                          EnterpriseStructureAssets.icons.headPhoneIcon.path,
                        ),
                      ]),
                      SizedBox(height: 24.h),
                      _buildSection(context, localizations.organizationalMetrics, EnterpriseStructureAssets.icons.metricsIcon.path, [
                      ...
                      SizedBox(height: 24.h),
                      _buildSection(context, localizations.description, EnterpriseStructureAssets.icons.descriptionIcon.path, [
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.businessUnitDetailsIcon.path,
                width: 20,
                height: 20,
                color: Colors.white,
              ),
