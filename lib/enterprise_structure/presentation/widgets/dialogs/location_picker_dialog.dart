            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    DigifyAsset(
                      assetPath: EnterpriseStructureAssets.icons.locationHeaderIcon.path,
                      width: 24,
                      height: 24,
      ...
      child: Row(
        ...
        children: [
          Padding(
            ...
            child: DigifyAsset(
              assetPath: EnterpriseStructureAssets.icons.infoCircleBlue.path,
              width: 20,
              height: 20,
          ...
          children: [
            SizedBox(
              ...
              child: _buildMethodCard(
                ...
                icon: EnterpriseStructureAssets.icons.mapPinBlue.path,
            ...
            SizedBox(
              ...
              child: _buildMethodCard(
                ...
                icon: EnterpriseStructureAssets.icons.locationHeaderIcon.path,
                title: 'Mark on Map',
            ...
            SizedBox(
              ...
              child: _buildMethodCard(
                ...
                icon: EnterpriseStructureAssets.icons.emailEnvelopePurple.path,
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.gpsLocationBlue.path,
                width: 20,
                height: 20,
                color: isDark ? AppColors.infoTextDark : AppColors.infoText,
              ),
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(top: 2.h),
                    child: DigifyAsset(
                      assetPath: EnterpriseStructureAssets.icons.errorCircleRed.path,
                      width: 24,
                      height: 24,
          ...
          ElevatedButton.icon(
            onPressed: () {},
            icon: DigifyAsset(assetPath: EnterpriseStructureAssets.icons.locationPinBlue.path, width: 20, height: 20, color: Colors.white),
            label: Text(
          ...
          TextButton.icon(
            onPressed: () {},
            icon: DigifyAsset(
              assetPath: EnterpriseStructureAssets.icons.refreshGray.path,
              width: 16,
              height: 16,
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.mapLocationGreen.path,
                width: 20,
                height: 20,
          ...
          ElevatedButton.icon(
            onPressed: () {},
            icon: DigifyAsset(
              assetPath: EnterpriseStructureAssets.icons.checkCircleGreen.path,
              width: 20,
              height: 20,
              color: Colors.white,
            ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    DigifyAsset(
                      assetPath: EnterpriseStructureAssets.icons.searchGreen.path,
                      width: 18,
                      height: 18,
                      color: isDark ? AppColors.successTextDark : AppColors.greenText,
                    ),
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            onPressed: null,
                            icon: DigifyAsset(
                              assetPath: EnterpriseStructureAssets.icons.searchWhite.path,
                              width: 16,
                              height: 16,
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.emailEnvelopePurple.path,
                width: 20,
                height: 20,
          ...
          ElevatedButton.icon(
            onPressed: () {},
            icon: DigifyAsset(assetPath: EnterpriseStructureAssets.icons.sendEmailPurple.path, width: 20, height: 20, color: Colors.white),
            label: Text(
          ...
          Row(
            children: [
              TextButton.icon(
                onPressed: () {},
                icon: DigifyAsset(
                  assetPath: EnterpriseStructureAssets.icons.copyGray.path,
                  width: 16,
                  height: 16,
                  color: isDark ? AppColors.textSecondaryDark : const Color(0xFF364153),
                ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    DigifyAsset(
                      assetPath: EnterpriseStructureAssets.icons.searchPurple.path,
                      width: 18,
                      height: 18,
                      color: isDark ? AppColors.purpleTextDark : AppColors.purpleText,
                    ),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.infoCircleAttendance.path,
                width: 18,
                height: 18,
                color: isDark ? AppColors.infoTextDark : AppColors.infoText,
              ),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              DigifyAsset(
                assetPath: EnterpriseStructureAssets.icons.resetIcon.path,
                width: 18,
                height: 18,
                color: isDark ? AppColors.textPrimaryDark : const Color(0xFF364153),
              ),
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                DigifyAsset(assetPath: EnterpriseStructureAssets.icons.saveLocationIcon.path, width: 18, height: 18, color: Colors.white),
                SizedBox(width: 8.w),
                Text(
                  'Save Geo-Location',
                  style: TextStyle(
