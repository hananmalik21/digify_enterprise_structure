...
class BulkUploadDialog extends StatelessWidget {
  ...
  Widget _buildHeader(BuildContext context, bool isDark, EnterpriseStructureLocalizations localizations, bool isMobile) {
    return Container(
  ...
  Widget _buildInstructions(EnterpriseStructureLocalizations localizations, bool isDark) {
    final instructions = [
  ...
  Widget _buildStepDownload(EnterpriseStructureLocalizations localizations) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        ElevatedButton.icon(
          onPressed: () {},
          icon: DigifyAsset(assetPath: EnterpriseStructureAssets.icons.downloadIcon.path, width: 20, height: 20, color: Colors.white),
          label: Text(
  ...
  Widget _buildStepUpload(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          ...
          child: Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  DigifyAsset(
                    assetPath: EnterpriseStructureAssets.icons.bulkUploadIconFigma.path,
                    width: 48,
                    height: 48,
  ...
  Widget _buildTemplatePreview(EnterpriseStructureLocalizations localizations, bool isDark, bool isMobile) {
    final columns = [
  ...
  Widget _buildFooter(BuildContext context, bool isDark, EnterpriseStructureLocalizations localizations, bool isMobile) {
    ...
    final uploadButton = ElevatedButton.icon(
      onPressed: () {},
      icon: DigifyAsset(assetPath: EnterpriseStructureAssets.icons.bulkUploadIconFigma.path, width: 20, height: 20, color: Colors.white),
      label: Text(
