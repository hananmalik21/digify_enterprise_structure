...
class DivisionDetailsDialog extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              DigifyAsset(assetPath: EnterpriseStructureAssets.icons.divisionHeaderIcon.path, width: 20, height: 20, color: Colors.white),
              SizedBox(width: 8.w),
              Text(
  ...
  Widget _buildBasicInformation(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildLeadership(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildLocation(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
    ...
    return Row(
      ...
      children: [
        Padding(
          ...
          child: DigifyAsset(
            assetPath: EnterpriseStructureAssets.icons.locationPinIcon.path,
            width: 16,
            height: 16,
  ...
  Widget _buildOrganizationalMetrics(EnterpriseStructureLocalizations localizations, bool isDark) {
    // Parse budget value
  ...
  Widget _buildDescription(EnterpriseStructureLocalizations localizations, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
