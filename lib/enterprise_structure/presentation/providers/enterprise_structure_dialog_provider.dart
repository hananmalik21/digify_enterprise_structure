...
import 'package:digify_enterprise_structure/enterprise_structure/domain/models/structure_level.dart';
...
class EnterpriseStructureDialogState {
  ...
  List<HierarchyLevel> toHierarchyLevels(EnterpriseStructureLocalizations localizations) {
  ...
  // List<HierarchyLevel> _getDefaultLevels(EnterpriseStructureLocalizations localizations) {
  //   return [
  //     HierarchyLevel(
  //       id: 'company',
