...
import 'package:digify_enterprise_structure/enterprise_structure/domain/models/org_unit_form_data.dart';
import 'package:digify_enterprise_structure/enterprise_structure/domain/models/org_unit_manager_employee.dart';
...
class OrgUnitFormState {
  ...
  final OrgUnitManagerEmployee? selectedManagerEmployee;
  ...
  OrgUnitFormState copyWith({
    ...
    String? parentId,
    String? parentName,
    OrgUnitManagerEmployee? selectedManagerEmployee,
...
class OrgUnitFormNotifier extends StateNotifier<OrgUnitFormState> {
  ...
  void updateManagerFromEmployee(OrgUnitManagerEmployee? employee) {
    if (employee == null) {
