...
import 'package:digify_enterprise_structure/integration/es_spreadsheet_export_provider.dart';
...
import 'package:digify_enterprise_structure/enterprise_structure/domain/models/org_structure_level.dart';
...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/providers/manage_component_values_enterprise_provider.dart';
...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/screens/manage_component_values/widgets/component_values_search_and_actions.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/screens/manage_component_values/widgets/component_values_search_and_actions_mobile.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/dialogs/org_unit_details_dialog.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/dialogs/org_unit_details_mobile_sheet.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/screens/manage_component_values/widgets/views/org_units_mobile_list.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/widgets/manage_enterprise_structure/manage_enterprise_structure_widgets/org_units_table_widget.dart';
...
class _LevelOrgUnitsViewState extends ConsumerState<LevelOrgUnitsView> {
  ...
  void _onExport(EnterpriseStructureLocalizations localizations) {
    final enterpriseId = ref.read(manageComponentValuesEnterpriseIdProvider);
    final activeLevels = ref.read(manageComponentValuesActiveLevelsProvider);
    if (activeLevels.levels.isEmpty) return;
  ...
  Future<void> _handleDelete(OrgStructureLevel unit) async {
    final confirmed = await DeleteConfirmationDialog.show(
      context,
      title: EnterpriseStructureLocalizations.of(context)!.delete,
