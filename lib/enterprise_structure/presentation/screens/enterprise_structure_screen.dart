...
import 'package:digify_enterprise_structure/integration/es_suite_routes.dart';
...
import 'package:digify_enterprise_structure/enterprise_structure/presentation/screens/manage_component_values/manage_component_values_screen.dart';
import 'package:digify_enterprise_structure/enterprise_structure/presentation/screens/manage_enterprise_structure/manage_enterprise_structure_screen.dart';
...
class EnterpriseStructureScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final moduleSelectionRoute = navExtra?.returnTo ?? EnterpriseStructureRoutes.dashboardModuleSelectionPath('enterpriseStructure');
        ...
        children: [
          Padding(
            ...
            child: isMobile
                ...
                : DigifyBreadcrumb(
                    items: [
                      DigifyBreadcrumbItem(label: 'Dashboard', onTap: () => context.go(EnterpriseStructureRoutes.dashboard)),
  ...
  String _childLabelForIndex(EnterpriseStructureLocalizations localizations, WidgetRef ref, int tabIndex) {
